...
public struct CustomLinksService {
    ...
    public func getCustomLinks(customTableId: Int) async throws -> [CustomLink] {
    ...
    /// - Returns: 該当するカスタムリンク
    public func getCustomLink(id: Int) async throws -> CustomLink {
    ...
    public func addCustomLink(_ request: CustomLinkAddRequest) async throws -> CustomLink {
    ...
    public func editCustomLink(id: Int, _ request: CustomLinkEditRequest) async throws -> CustomLink {
    ...
    public func deleteCustomLink(id: Int) async throws {
